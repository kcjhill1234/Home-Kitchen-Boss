 ...
 */
const _get = function get(object, property, receiver) { if (object === null) object = Function.prototype; var desc = Object.getOwnPropertyDescriptor(object, property); if (desc === undefined) { var parent = Object.getPrototypeOf(object); if (parent === null) { return undefined; }  return get(parent, property, receiver);  } else if ("value" in desc) { return desc.value; }  var getter = desc.get; if (getter === undefined) { return undefined; } return getter.call(receiver);  };
...
(function (factory) {
  ...
  function find(selector, context) {
    context = context || doc;
    let elems = classMatch.test(selector)
  ...
  let fn = (cash.fn = cash.prototype = Init.prototype = {
    // jshint ignore:line
    cash: true,
    length: 0,
    push: push,
  ...
  function unique(collection) {
    return cash(
      slice.call(collection).filter((item, index, self) => {
  ...
  fn.extend({
    ...
    filter: function (selector) {
      ...
      let comparator = isFunction(selector)
        ? selector
  ...
  fn.extend({
    ...
    has: function (selector) {
      let comparator = isString(selector)
        ? function (el) {
...
$jscomp.polyfill(
  ...
  (e) => {
    return e ? e : function () {
      return $jscomp.iteratorFromArray(this, (e) => {
      return e;
    });
    };
...
(function (r) {
  ...
  function T(a) {
    a = a.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i, (a, c, d, k) => {
      return c + c + d + d + k + k;
    });
  ...
  function ba(a, c) {
    let d = {},
      b;
    for (b in a) {
      var f = I(a[b], c); h.arr(f) && (f = f.map((a) => {
          return I(a, c);
        })),
        1 === f.length && (f = f[0]));
      d[b] = f;
      ...
      [
        ...
        },
        {
          ...
          value: function _handleMouseLeave(e) {
            ...
            let leaveToDropdownContent = !!$(toEl).closest(".dropdown-content")
              .length;
        ...
        },
        {
          ...
          value: function _handleTriggerClick(e) {
            ...
            if (e.target && $trigger.length) {
              ...
              let sidenavInstance = document.getElementById(sidenavId)
                .M_Sidenav;
              if (sidenavInstance) {
        ...
        },
        {
          ...
          value: function _handleWindowScroll() {
            ...
            for (let _i = 0; _i < ScrollSpy._elementsInView.length; _i++) {
              let _scrollspy = ScrollSpy._elementsInView[_i];
        ...
        },
        {
          ...
          value: function _renderDropdown(data, val) {
            ...
            if (this.options.sortFunction) {
              let sortFunctionBound = function (a, b) {
      ...
      [
        ...
        },
        {
          ...
          value: function deleteChip(chipIndex) {
            ...
            this.$chips = this.$chips.filter((el) => {
              return $(el).index() >= 0;
            });
      ...
      [
        ...
        },
        {
          ...
          value: function destroySelects() {
            let oldYearSelect = this.calendarEl.querySelector(
              ".orig-select-year"
            );
            if (oldYearSelect) {
              M.FormSelect.getInstance(oldYearSelect).destroy();
            }
            let oldMonthSelect = this.calendarEl.querySelector(
              ".orig-select-month"
            );
            if (oldMonthSelect) {
        ...
        },
        {
          ...
          value: function draw(force) {
            ...
            let monthSelect = this.calendarEl.querySelector(
              ".orig-select-month"
            );
          ...
          value: function _buildHoursView() {
            ...
            if (this.options.twelveHour) {
              ...
              for (let _i2 = 0; _i2 < 24; _i2 += 1) {
                ...
                let _radian = _i2 / 6 * Math.PI;
                let inner = _i2 > 0 && _i2 < 13;
                let _radius = inner ? this.options.innerRadius : this.options.outerRadius;
                _tick.css({
                  left:
                    this.options.dialRadius +
        ...
        },
        {
          ...
          value: function _scroll(x) {
            ...
            if (this.showIndicators) {
              ...
              let activeIndicator = this.$indicators.find(
          ...
          value: function _setupDropdown() {
            ...
            if (!this.el.disabled) {
              ...
              dropdownOptions.onOpenEnd = function (el) {
                let selectedOption = $(_this71.dropdownOptions)
                  .find(".selected")
                  .first();
                ...
                if (selectedOption.length) {
                  ...
                  if (_this71.dropdown.isScrollable) {
                    let scrollOffset = selectedOption[0].getBoundingClientRect().top - _this71.dropdownOptions.getBoundingClientRect().top; // scroll to selected option
